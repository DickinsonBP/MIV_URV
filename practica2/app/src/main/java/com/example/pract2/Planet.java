...
public class Planet {
    ...
    public Planet(Context ctx, int filenameId) {
    ...
    public void draw(GL10 gl) {
        ...
        /*Sin diferenciar si es orbita o no, hay que triangular las dos*/
    ...
    public void loadTexture(GL10 gl, Context context, int textureResourceId) {
        ...
        // Construct an input stream to texture image "res\raw\nehe.png"
